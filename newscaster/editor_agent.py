...
_ADVERSARY_SYSTEM = (
    ...
    "contradicted), uncertain, or not grounded in the provided material. When in doubt, REJECT — leaving a "
    "flagged line unchanged is safe; broadcasting a wrong correction is not.\n\n"
