...
REPETITION_REMOVER_TEMPLATE = (
    ...
    "STRICT THRESHOLD: More activity inside an already active conflict is an UPDATE, not a MAJOR "
    "ESCALATION—even if it is important or a source calls it an escalation. Another round of strikes, "
    "retaliation by the same parties, expanded targets or geography, renewed or enforced blockades, "
    "new casualties, threats, sanctions, market effects, congressional notifications, and legal or "
    "war-powers arguments are UPDATEs. The event must change the kind or state of the story, not merely "
    "its intensity, scale, or latest details. When uncertain, classify it as UPDATE.\n\n"
